...
var changeCity = function(city) {
  ...
  cityWeather.getCurrentWeather(function(currCityWeather) {
      ...
      // displayWeather(currCityWeather);
  });
}
...
//   var div = document.getElementById("country-list");
//   div.firstElementChild.innerText = country["name"];
// }

// use display_weather object? pass id of div?
